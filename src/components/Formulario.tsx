...
export default function Formulario(props: FormularioProps) {
    ...
    return (
        <div>
            ...
            <Entrada texto="Nome" placeholder="Digite seu nome" valor={nome} valorMudou={setNome} className="mb-4"></Entrada>
            <Entrada texto="Idade" placeholder="Digite sua idade" tipo="number" valor={idade} valorMudou={setIdade}></Entrada>
